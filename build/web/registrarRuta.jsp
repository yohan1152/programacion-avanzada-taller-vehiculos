<%-- 
    ...
    Created on : 15/03/2020, 04:16:02 PM
    Author     : Yohan
--%>
...
<head>
    ...
    <meta name="description" content="Página donde se van a registrar todos las rutas" />
										...
										<div>
                                                                                    ...
                                                                                    <form action="rutaControlador" method="POST">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <input type="text" name="txtEstacionRuta" class="form-control" placeholder="Ingresar nombre de la estación" required>
                                                                                            </div>
                                                                                        </div>
                                                                                        <br><br><br>
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-10">
                                                                                                <select name="txtVehiculoRuta" class="form-control" required>
                                                                                                    <%
                                                                                        ...
                                                                                        <br><br>
                                                                                        <button type="submit" name="btnGuardarRuta" class="btn btn-success">
